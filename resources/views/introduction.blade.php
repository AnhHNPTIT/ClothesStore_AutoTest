                    ...
                    <div class="col-sm-24 em-col-main">
                        <div class="em_post-item">                           
                            <div class="" style="text-align : justify; padding: 10px 10px; line-height : 30px;">
                                ...
                                <p>Cửa hàng quần áo - Clothes Store là nơi chuyên cung cấp các thực phẩm chức năng cho mọi lứa tuổi.</p>
                                ...
                                <p>Mọi vấn đề thắc mắc, xin liên hệ số điện thoại hotline: 0987 654 321 hoặc gửi thư tới địa chỉ: anhhn@gmail.com</p>
                            </div>
                        </div>
                    </div><!-- /.em-col-main -->
                </div>
