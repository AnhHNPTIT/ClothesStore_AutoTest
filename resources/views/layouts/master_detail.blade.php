                    ...
                    <div id="em-mheader-top" class="row" style="background : #fff; margin-top: -10px;">
                        ...
                        <div class="em-logo col-xs-10" style="margin-right: 0px;">
                            <a href="tel:0899766566">
                                ...
                                <span style="font-weight:bold; font-size:14px;"><span style="color:#0000FF;">0987 654 321</span></span>
                            </a>
                        </div>
                    </div>
                                                        ...
                                                        <div class="em_nav" id="toogle_menu_7_5505">
                                                            <ul class="hnav em_menu_mobile">
                                                                ...
                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-medkit">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thuoc') }}"> <span style="text-transform: uppercase;"> Nữ </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-dropbox">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thuc-pham-chuc-nang') }}"> <span style="text-transform: uppercase;"> Nam </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa fa-shopping-cart">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/hang-tieu-dung') }}"> <span style="text-transform: uppercase;"> Trẻ em </span> </a>
                                                                </li><!-- /.menu-item-link -->

                                                                <li class="menu-item-link menu-item-depth-0 dd-menu-link fa fa-ambulance">
                                                                    <a class="em-menu-link" href="{{ url('/cua-hang/thiet-bi-y-te') }}"> <span style="text-transform: uppercase;"> Khác </span> </a>
                                                                </li><!-- /.menu-item-link -->
                                        ...
                                        <div id="hotline" class="f-left">
                                            <ul style="margin-bottom: 0px !important;">
                                                <li class="">
                                                    <a href="tel:0899766566">
                                                        <img src="{{asset('/images/icons/call-2.gif')}}" alt="" style="width: 25px; height: 25px;">
                                                        <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span style="color:#0000FF;">0987 654 321</span></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 text-center" style="margin-bottom : 20px;">
                                                ...
                                                <p style="text-align : center; color: #ffffff;">
                                                    <a href="{{ url('/') }}">
                                                        Hộ kinh doanh <span>Cửa hàng quần áo</span>
                                                    </a>
                                                </p>
                                                <p style="text-align : center; color: #ffffff;">
                                                ...
                                                <ul id="collapse02" class="em-links em-block-content block-info">
                                                    <li class="em-links-item">
                                                        <a href="tel:0899766566">
                                                            ...
                                                            <span style="font-weight:bold; font-size:14px;"><span>Hotline:</span> <span>0987 654 321</span></span>
                                                        </a>
                                                    </li>
                                                    <!-- <style>
