...
<div class="row">
    ...
    <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
            ...
            <div class="menu-wrapper hidden-xs">
                ...
                <div class="menuleft">
                    <div id="menu-default" class="mega-menu em-menu-icon">
                            ...
                            <div class="em_nav" id="toogle_menu_5_4607">
                                <ul class="vnav em-menu-icon effect-menu em-menu-long">
                                    <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                                        <a class="em-menu-link" href="{{ url('/cua-hang/bo-sung-vitamin-khoang-chat') }}"> <span style="text-transform: uppercase;"> Nữ </span> </a>
                        ...
                        <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                            <a class="em-menu-link" href="{{ url('/cua-hang/nuoc-tang-luc-giai-khat') }}"> <span style="text-transform: uppercase;"> Nam </span> </a>
                            <ul class="menu-container">
                                <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                                    <ul class="menu-container">
                                        <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
                ...
                <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
                    <a class="em-menu-link" href="{{ url('/cua-hang/giau-chat-xo-tieu-hoa') }}"> <span style="text-transform: uppercase;"> Trẻ em </span> </a>
                    <ul class="menu-container">
                        <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                            <ul class="menu-container">
                                <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
        ...
        <li class="menu-item-link menu-item-depth-0 fa fa-dropbox menu-item-parent" style="width: 300px;">
            <a class="em-menu-link" href="{{ url('/cua-hang/chuc-nang-dac-biet') }}"> <span style="text-transform: uppercase;"> Khác </span> </a>
            <ul class="menu-container">
                <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col10  fix-top menu-item-parent" style="">
                    <ul class="menu-container">
                        <li class="menu-item-vbox menu-item-depth-2 col-sm-12 alpha menu-item-parent" style="">
                    ...
                    <div id="emtabs_1" class="em-tabs emtabs r-tabs">
                        <ul class="em-tabs-control tabs-control r-tabs-nav">
                            <li class="r-tabs-tab r-tabs-state-active">
                                <a class="r-tabs-anchor active" href="#tab_emtabs_1_1" style="text-transform: uppercase;"> <span class="icon"></span>Nữ</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_2" style="text-transform: uppercase;"> <span class="icon"></span>Nam</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_3" style="text-transform: uppercase;"> <span class="icon"></span>Trẻ em</a>
                            </li>

                            <li class="r-tabs-state-default r-tabs-tab">
                                <a class="r-tabs-anchor" href="#tab_emtabs_1_4" style="text-transform: uppercase;"> <span class="icon"></span>Khác</a>
                            </li>
                        </ul>
